...
void APP_Initialize(void) {
    ...
    T5CKR = 0b0100;             // B9 (Left Motor) is read by T5CK
    T3CKR = 0b0100;             // B8 (Right Motor) is read by T3CK
    ...
    PR4 = 23999;                // 48000000 Hz / 500 Hz / 4 - 1 = 23999 (500Hz PI Ctrl from 48MHz clock with 4:1 prescaler)
